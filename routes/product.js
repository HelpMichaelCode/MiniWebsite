...
const SQL_SELECT_ALL = 'SELECT * FROM dbo.Product ORDER BY ProductId ASC for json path;';
...
// for json path, without_array_wrapper - use for single json result
const SQL_SELECT_BY_CATID = 'SELECT * FROM dbo.Product WHERE CategoryId = @id ORDER BY ProductId ASC for json path;';
